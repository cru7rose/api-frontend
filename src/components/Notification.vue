          ...
          <div class="p-4">
            <div class="flex items-start">
              <div class="flex-shrink-0">
                ...
                <XCircleIcon v-else-if="store.type === 'error'" class="h-6 w-6 text-red-400" aria-hidden="true" />
              ...
              <div class="ml-3 w-0 flex-1 pt-0.5">
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ store.message }}</p>
              </div>
